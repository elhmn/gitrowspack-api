...
app.post(
  `${BASE_ROUTE}/get/:project/:database/:collection`,
  async (req, res) => {
    const filter = req.body["filter"];

    const data = await gitrows.get(getPath(req), filter);
    res.json(data);
  }
);
...
app.post(
  `${BASE_ROUTE}/put/:project/:database/:collection`,
  async (req, res) => {
    const dataToInsert = req.body["data"];

    const data = await gitrows.put(getPath(req), dataToInsert);
    res.json(data);
  }
);
...
app.post(
  `${BASE_ROUTE}/update/:project/:database/:collection`,
  async (req, res) => {
    const filter = req.body["filter"];
    const dataToInsert = req.body["data"];

    const data = await gitrows.update(getPath(req), dataToInsert, filter);
    res.json(data);
  }
);
...
app.post(
  `${BASE_ROUTE}/replace/:project/:database/:collection`,
  async (req, res) => {
    const dataToInsert = req.body["data"];

    const data = await gitrows.replace(getPath(req), dataToInsert);
    res.json(data);
  }
);
...
app.post(
  `${BASE_ROUTE}/delete/:project/:database/:collection`,
  async (req, res) => {
    const filter = req.body["filter"];

    const data = await gitrows.delete(getPath(req), filter);
    res.json(data);
  }
);
...
app.post(
  `${BASE_ROUTE}/create/:project/:database/:collection`,
  async (req, res) => {
    const data = await gitrows.create(getPath(req));
    res.json(data);
  }
);
...
app.post(
  `${BASE_ROUTE}/drop/:project/:database/:collection`,
  async (req, res) => {
    const data = await gitrows.drop(getPath(req));
    res.json(data);
  }
);
...
app.get(`${BASE_ROUTE}/:project/:database/collections`, async (req, res) => {
  res.json({
    ...
    collections: await gitrows.getCollections(
      req.params.project,
      req.params.database
    ),
  });
